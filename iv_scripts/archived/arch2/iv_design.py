...
d_path  = home + "/Projects/FPGA_Projects/RTL/design"
tb_path = home + "/Projects/FPGA_Projects/RTL/design"
...
if name in os.listdir(d_path):
	...
	try:
	    ...
	    loc = ["// Local Variables: \n",
		   "// Verilog-Library-Directories:(\"~/Projects/FPGA_Projects/RTL/design/"+name+"/\" \".\") \n",
		   "// End:"]
	    print('Emac linkers ;)')
